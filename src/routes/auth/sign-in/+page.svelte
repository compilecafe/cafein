...
>
	<div class="inner">
		...
		>
			...
			<form action="" class="flex w-full flex-col gap-y-4">
				<div class="flex flex-col gap-2">
					<label for="username" class="font-medium">What's your username?</label>
					<div class="relative">
						<input
							type="text"
							id="username"
				...
				<div class="flex flex-col gap-2">
					<label for="password" class="font-medium">And your password?</label>
					<div class="relative">
						<input
							type="password"
							id="password"
